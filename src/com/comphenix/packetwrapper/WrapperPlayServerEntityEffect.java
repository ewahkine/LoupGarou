...
public class WrapperPlayServerEntityEffect extends AbstractPacket {
    ...
    {
        handle.getBytes().write(0, (byte) (effect.getType().getId() & 255));
        handle.getBytes().write(1, (byte) (effect.getAmplifier() & 255));
        handle.getIntegers().write(1, Math.min(effect.getDuration(), 32767));
        ...
        handle.getBytes().write(2, option);
    }
}
